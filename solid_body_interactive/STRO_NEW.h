...
public:
        ...
        :BASE(stream_type,0,fluids_parameters.NONE),tests(*this,solid_body_collection)
    {
		...
		springConst = 400;
		dampConst = 10;
		prismaticMin = -100;	//min limit the spring can move in y space
		prismaticMax = -.5;	//max limit the spring can move in y space
        wheels_offset = 0.6;
        sphere_offset = 0.02;
		jeepX = 0.0;
		jeepY = 0.0;
	...
	void Setup_Explosions() {
		for (int i = 0; i < num_explosions; ++i) {
			explosions[i] = pushRenderingModel(
				stream_type,
				std::string("../../Public_Data/Archives/Rigid_Bodies/explosion"),
...
*/
    ...
    void Initialize_Bodies() PHYSBAM_OVERRIDE
    {
	    ...
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/skybox", 
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(1,1,1), 1.)),
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(1,1,1), 1.)),
...
//		jeep->X() = TV(jeepX, jeepY + y_offset, jeepZ);
	    ...
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/jeepbody", 
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(151./255., 10./255., 20./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(151./255., 10./255., 20./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/insidegloss",
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(67./255., 34./255., 16./255.), 1.)),
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(67./255., 34./255., 16./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/controls",
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(157./255., 125./255., 83./255.), 1.)),
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(157./255., 125./255., 83./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/floor",
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(80./255., 67./255., 48./255.), 1.)),
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(80./255., 67./255., 48./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontpane",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/topframe",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/fenders",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/chairs",
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(137./255., 125./255., 103./255.), 1.)),
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(137./255., 125./255., 103./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/grille",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/leftsidemirror",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 210./255.), 0.95)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 210./255.), 0.95)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/leftsidemirrorhold",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/rightsidemirror",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 210./255.), 0.95)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 210./255.), 0.95)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/rightsidemirrorhold",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/leftwiper",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/rightwiper",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/sidegrille",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backgrille",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/toplightholds",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontsidelightholds",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backlightholds",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/steering",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backtire",
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(60./255., 67./255., 73./255.), 1.)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/toplights",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 220./255.), 0.6)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 220./255.), 0.6)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontlights",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 220./255.), 0.6)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(210./255., 210./255., 220./255.), 0.6)),
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backlights",
	    		...
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backsmalllights",
	    		...
	    		-1, TV(0, height, 0));
	    pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontsidelights",
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(250./255., 161./255., 5./255.), 0.6)),
	    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(250./255., 161./255., 5./255.), 0.6)),
	    		-1, TV(0, height, 0));
	    ...
	    car_flag = pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/flag",
    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(1,1,1),1)),
    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(1,1,1),1)),
	...
	void add_jeep_wheels() {
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backlefttire",
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backrighttire",
				OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(50./255., 50./255., 50./255.), 1.)),
				OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(50./255., 50./255., 50./255.), 1.)));
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontlefttire",
				OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(50./255., 50./255., 50./255.), 1.)),
				OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(50./255., 50./255., 50./255.), 1.)));
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontrighttire",
				OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(50./255., 50./255., 50./255.), 1.)),
				OPENGL_MATERIAL::Matte(OPENGL_COLOR(TV(50./255., 50./255., 50./255.), 1.)));
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backleftspoke",
				OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/backrightspoke",
				OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontleftspoke",
				OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
		...
		pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/frontrightspoke",
				OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(200./255., 200./255., 200./255.), 1.)),
		...
		solid_body_collection.rigid_body_collection.articulated_rigid_body.iterative_tolerance = 1e-2;	//TODO: Performance?
...
//	terrain = &tests.Add_Height_Field("../../Public_Data/Archives/Rigid_Bodies/height_map.jpg", TV(3000, 200, 3000));
...
//		terrain->simplicial_object = 0;
	...
	void Scene0() {
		init_heightmap("../../Public_Data/Archives/Rigid_Bodies/heightmap0_low.jpg", "../../Public_Data/Archives/Rigid_Bodies/heightmap0", TV(300,50,300));
		Add_Flag(TV(10, 3, 15));
	...
	void Scene1() {
		...
		init_heightmap("level01", "../../Public_Data/Archives/Rigid_Bodies/level01_lopoly", TV(250, 60, 250), TV(72, 5, 90), rot);
	}
	...
	void Add_Landmine(float centerx, float centerz, float dx, float dz, int number, float mine_chance=0.25, float excluded_radius=10.0) {
		...
		for (int i = 0; i < number; ++i) {
			...
			float x, y, z;
			do {
				x = centerx + dx * (rand() / (float) RAND_MAX - 0.5);
				z = centerz + dz * (rand() / (float) RAND_MAX - 0.5);
			...
			char filename[100];
			sprintf(filename, "../../Public_Data/Archives/Rigid_Bodies/rock%d_lowpoly", (rand() % 3) + 1);
			...
			TV color = (debug_mines && is_mine) ? TV(1.0, 0.0, 0.0) : TV(shade / 255., shade / 255., shade / 255.);
	...
	void Scene2() {
		...
		//init_terrain("level02tri", "../../Public_Data/Archives/Rigid_Bodies/level02tri");
	...
	void Scene3() {
		float s = 2;
		init_terrain("level03_lowpoly", "../../Public_Data/Archives/Rigid_Bodies/level03_hipoly", TV(125 * s, -10 * s, 125 * s), s);
		...
		case PLANKS:
			{
				for (int i = 0; i < num / 2; ++i) {
					...
					planks[i]->Set_Coefficient_Of_Restitution(0.1);
				...
				for (int i = num - 1; i >= num / 2; --i) {
					planks[i] = &tests.Add_Rigid_Body("bridge_plank", 4 * scale, (T)1);
					planks[i]->Set_Coefficient_Of_Restitution(0.1);
					planks[i]->X() = frame.r.Rotation_Matrix() * TV(0, 0, ((is_static?0:5) * (num - 1) - 0.1 * num + (is_static?10:5) * i) * scale) + frame.t;
					planks[i]->Rotation() = frame.r;
					planks[i]->Set_Mass(mass);
					planks[i]->is_static = is_static;
					pushSimulationModel(planks[i], OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(1,1,1),1)),
		...
		case RUBBER:
			{
				for (int i = 0; i < num; ++i) {
					...
					if (i != 0 ) {
						POINT_JOINT<TV>* st = new POINT_JOINT<TV>();
						st->Use_Twist_Constraint(-pi / 12, pi / 12);
						st->Use_Phi_Constraint(0., 0.);
						st->Use_Theta_Constraint(0, 0);
	...
	void Scene4() {
		init_terrain("level05", "../../Public_Data/Archives/Rigid_Bodies/level05");
	...
	void Scene5() {
		init_heightmap("../../Public_Data/Archives/Rigid_Bodies/desert_heightmap_lopoly.jpg", "../../Public_Data/Archives/Rigid_Bodies/desert_heightmap", TV(300,15,300));
		Add_Flag(TV(10, 3, 15));
	...
	void Scene6() {
		init_terrain("mountain_ice_lowpoly", "../../Public_Data/Archives/Rigid_Bodies/mountain_ice", TV(0, -12, -300), 10);
	...
	void Add_Flag(TV where = TV(0, 0, 0), T flagScale=2.0, T flagElevation=6.0) {
		...
		flagpole->Rotation() = ROTATION<TV>(pi / 2, TV(1.,0.,0.));
		...
		pole_render->Rotation() = ROTATION<TV>(pi / 2, TV(1.,0.,0.));
		process_rendering(-1, OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(1,1,1), 1.)),
			OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(1,1,1), 1.)));

		flag = pushRenderingModel(stream_type, "../../Public_Data/Archives/Rigid_Bodies/flag",
    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(1,1,1),1)),
    		OPENGL_MATERIAL::Metal(OPENGL_COLOR(TV(1,1,1),1)),
    		-1, TV(0, 2.98, 0), false, 2.0f, true, false, false, false, false);
